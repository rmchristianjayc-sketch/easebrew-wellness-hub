...
// 1 pack = 10 sachets, 2 sachets/day = 5 days actual consumption
// App validity = 2x consumption (buffer para may time mag-reorder)
// ============================================================
...
// ============================================================
// REMOVED (dead code — session is now cookie-based):
//   ❌ getLocalSession()   — dati nag-read ng eb_session sa localStorage
//   ❌ saveLocalSession()  — dati nag-save ng eb_session sa localStorage
//   ❌ clearLocalSession() — dati nag-clear ng eb_session sa localStorage
// ============================================================