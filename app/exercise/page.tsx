...
const EXERCISES = [
  { day: 1, week: "Week 1", weekday: "Lunes", intensity: "🟢 Beginner", totalTime: "~30 mins", target: "Legs, Core, Upper Body", isRest: false, warmup: "March in place • Ankle circles (10x each foot) • Shoulder rolls (10x)", main: "Seated leg raises — 2 sets x 10 reps\nWall push-ups — 2 sets x 8 reps\nSeated torso twist — 2 sets x 8 reps each side", cooldown: "Neck rolls • Deep breathing • Calf stretch seated — 5 mins", note: "Simula na! Huwag mag-force. Kung masakit — stop agad." },
  ...
  { day: 3, week: "Week 1", weekday: "Miyerkules", intensity: "⚪ Rest", totalTime: "~20 mins", target: "Full Body Recovery", isRest: true, warmup: "", main: "🌿 REST DAY — Active Recovery\n\nLight walking sa loob ng bahay (10–15 mins)\nGentle stretching lang (5 mins)", cooldown: "Full body gentle stretch • Ankle circles • Shoulder rolls — 10 mins", note: "I-massage ang Avocado Miracle Oil sa joints ngayong gabi. Importante ang recovery!" },
  ...
  { day: 19, week: "Week 3", weekday: "Biyernes", intensity: "🟠 Moderate", totalTime: "~40 mins", target: "Core, Lower Back, Hips", isRest: false, warmup: "Marching arms • Lateral shuffles (mabagal) • Hip hinge warm-up • Wrist rotations — 7 mins total", main: "Romanian deadlift (no weight — hinge lang) — 3 sets x 12 reps\nSide plank (sa tuhod) — 3 sets x 15 secs each side\nSeated good morning (forward lean, straight back) — 3 sets x 10 reps\nPallof press (may band) — 3 sets x 10 reps each side", cooldown: "Lower back stretch • Piriformis stretch • Full body roll-down stretch — 6 mins", note: "Core day! Kapag malakas ang core mo — automatic na bababa ang back pain mo." },
  { day: 20, week: "Week 3", weekday: "Sabado", intensity: "🟠 Moderate", totalTime: "~45 mins", target: "Full Body Challenge", isRest: false, warmup: "Full warm-up: March + swings + circles • Light jogging in place — 7 mins total", main: "🔄 WEEK 3 CHALLENGE CIRCUIT (2 rounds, 45 secs rest)\n\nSumo squat x 12\nIncline push-up x 10\nGlute bridge march x 10\nDead bug x 8 each\nStep-up x 10 each\nPlank on knees x 25 secs", cooldown: "Full body stretch • 10 mins stretching • Deep breathing — 10 mins total", note: "3 weeks done! Ang joints mo ay nagpapalakas na kahit hindi pa halata sa labas." },
  { day: 21, week: "Week 3", weekday: "Linggo", intensity: "⚪ Rest", totalTime: "0 mins", target: "Full Body Rest", isRest: true, warmup: "", main: "💤 FULL REST DAY\n\n3 weeks! I-check ang suot mong damit — baka medyo gaan na ang katawan mo.", cooldown: "", note: "3 weeks! I-check ang suot mong damit — baka medyo gaan na ang katawan mo." },
  ...
  { day: 24, week: "Week 4", weekday: "Miyerkules", intensity: "⚪ Rest", totalTime: "~50 mins", target: "Active Recovery", isRest: true, warmup: "", main: "🌿 REST DAY — Active Recovery\n\n25-min brisk walk o swimming (kung malapit)\nFull yoga session: cat-cow, pigeon pose, seated forward fold, supine twist", cooldown: "Full body deep stretch — 10 mins", note: "Week 4 na — ang active recovery ay mas importante kaysa dati. Bigyan ng oras ang katawan." },
  ...
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", background: CREAM, minHeight: "100vh", paddingBottom: 100 }}>
      ...
      <div style={{ background: G, padding: "24px 24px 20px", color: "#fff" }}>
        ...
        <div style={{ marginTop: 14 }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
            <p style={{ fontSize: 13, margin: 0, opacity: 0.8 }}>{completedDays.length} / 30 days — {progress}%</p>
            <p style={{ fontSize: 13, margin: 0, color: GOLD, fontWeight: 700 }}>{30 - completedDays.length} days to go!</p>
          </div>
      ...
      <div style={{ background: "#FFFFFB", borderBottom: `2px solid ${CREAM}`, padding: "12px 20px", display: "flex", gap: 20, overflowX: "auto" as const }}>
        {[
          { icon: "☕", text: "Easebrew 30 mins before mag-exercise" },
          { icon: "🌿", text: "Avocado Oil after workout" },
          { icon: "💧", text: "2 glasses before at after" },
        ...
        {filteredDays.map((d) => {
          ...
          return (
            <div key={d.day} style={{ marginBottom: 14 }}>
              <div onClick={() => setExpandedDay(isExpanded ? null : d.day)} style={{
                ...
                <div style={{ marginTop: 8, display: "flex", gap: 8, flexWrap: "wrap" as const }}>
                  ...
                  {isDone && <span style={{ background: "#E8F5E0", color: G, borderRadius: 20, padding: "3px 12px", fontSize: 12, fontWeight: 700 }}>✅ Done na!</span>}
                </div>
                  ...
                  <div style={{ marginTop: 16, borderTop: `1px solid ${CREAM}`, paddingTop: 16 }}>
                    {!d.isRest && d.warmup && (
                      <div style={{ background: "#E8F5E0", borderRadius: 12, padding: "12px 16px", marginBottom: 12 }}>
                        <p style={{ fontSize: 12, fontWeight: 700, color: G, margin: "0 0 6px 0", textTransform: "uppercase" as const, letterSpacing: 0.8 }}>🌅 Warm-Up (5–7 mins)</p>
                    ...
                    <div style={{ background: d.isRest ? "#F5F5F5" : "#FFFFFB", border: `1.5px solid ${d.isRest ? "#ddd" : AMBER}`, borderRadius: 12, padding: "12px 16px", marginBottom: 12 }}>
                      <p style={{ fontSize: 12, fontWeight: 700, color: AMBER, margin: "0 0 6px 0", textTransform: "uppercase" as const, letterSpacing: 0.8 }}>💪 {d.isRest ? "Rest Day Activity" : "Main Workout (15–20 mins)"}</p>
                      <p style={{ fontSize: 15, color: DARK, margin: 0, lineHeight: 1.7, whiteSpace: "pre-line" as const }}>{d.main}</p>
                    </div>

                    {d.cooldown && (
                      <div style={{ background: "#E6F1FB", borderRadius: 12, padding: "12px 16px", marginBottom: 12 }}>
                        <p style={{ fontSize: 12, fontWeight: 700, color: "#185FA5", margin: "0 0 6px 0", textTransform: "uppercase" as const, letterSpacing: 0.8 }}>🧘 Cool-Down (5 mins)</p>
                    ...
                    <div style={{ background: CREAM, borderRadius: 12, padding: "14px 16px", marginBottom: 14 }}>
                      <p style={{ fontSize: 14, fontWeight: 700, color: G, margin: "0 0 12px 0" }}>📊 I-track ang day na ito</p>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
                        {[
                          { key: "easebrew", label: "☕ Na-inom ang Easebrew?", val: track.easebrew },
                          { key: "exercise", label: "💪 Exercise natapos?", val: track.exercise },
                          { key: "avocado", label: "🌿 Avocado Oil na-massage?", val: track.avocado },
                        ].map(item => (
                          <div key={item.key} onClick={(e) => { e.stopPropagation(); saveTrack(d.day, { ...track, [item.key]: !item.val }); }} style={{
                        ...
                        <div style={{ background: "#fff", border: "1.5px solid #ddd", borderRadius: 10, padding: "10px 12px" }} onClick={e => e.stopPropagation()}>
                          <p style={{ fontSize: 13, margin: "0 0 4px 0", color: DARK }}>💧 Water (glasses)</p>
                          <input type="number" min={0} max={12} value={track.tubig}
                            onChange={e => saveTrack(d.day, { ...track, tubig: Number(e.target.value) })}
                            style={{ width: "100%", padding: "4px 8px", borderRadius: 6, border: "1px solid #ddd", fontSize: 16, textAlign: "center" as const, background: "transparent" }} />
                        </div>
                      </div>
                      ...
                      <div onClick={e => e.stopPropagation()}>
                        <textarea placeholder="Notes / Observations (optional)..." value={track.notes}
                          onChange={e => saveTrack(d.day, { ...track, notes: e.target.value })}
                          rows={2} style={{ width: "100%", padding: "10px 12px", borderRadius: 10, border: "1.5px solid #ddd", fontSize: 15, background: "#fff", resize: "none", boxSizing: "border-box" as const, color: DARK }} />
                      </div>
                    </div>
                    ...
                    <button onClick={(e) => toggleComplete(d.day, e)} style={{
                      ...
                      {isDone ? "✗ Undo" : (d.isRest ? "✅ Rest Day Complete!" : "✅ Workout Complete!")}
                    </button>
                  </div>
                )}
              </div>
      ...
      <div style={{ padding: "24px 20px 0" }}>
        <div style={{ background: "#FEF0F0", border: "2px solid #ef4444", borderRadius: 18, padding: "20px 24px" }}>
          ...
          {[
            ...
            "Kumonsulta sa doktor bago magsimula — lalo na kung may diagnosed na arthritis o heart condition",
            "Huwag mag-exercise nang empty stomach — kumain ng konti (banana o pandesal) 1 hr bago",
          ].map((tip, i) => (
