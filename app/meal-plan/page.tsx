...
const MEAL_PLAN = [
  ...
  { day: 20, week: "Week 3", weekday: "Sabado",       agahan: "Easebrew + Whole wheat sinangag + Lechon manok (2 pcs) + Tomato",            tanghalian: "Kare-kare (oxtail, lean) + Mga gulay + 1 tsp bagoong + Brown rice",     merienda: "Halo-halo (light version, walang ice cream)",    hapunan: "Tinolang hipon + May papaya at malunggay + Brown rice",   calories: "~1,820 kcal", nutrients: "Collagen, Fiber, Vit A",            focus: "Cheat Day (Balanced)" },
            ...
            >
              ...
              {isExpanded && (
                <div style={{ marginTop: 18, borderTop: `1.5px solid ${CREAM}`, paddingTop: 16 }}>
                  ...
                  >
                    {isDone ? "↩ I-undo" : "✅ Tapos na ang Araw na Ito!"}
                  </button>
                </div>
              )}
            </div>
